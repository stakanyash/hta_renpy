...
**Текущая публичная версия носит демонстрационный характер, к полноценному релизу вид игры может очень сильно измениться.**

**Данный проект является неофициальным! Разработчики (Targem Games) и издатели (НАО "Бука") не имеют к нему какого-либо отношения.**
...
- Сюжет первого региона по обеим веткам

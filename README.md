...
**Hard Truck Apocalypse: Ren'Py** - фанатский перенос сюжета и некоторых элементов геймплея оригинальной игры на движок для визуальных новелл **RenPy**. 

Проект находится в активной разработке и не завершён на 100%. 

На данный момент доступен только сюжет первого региона по обеим веткам.

<div align="center">

**[Дисклеймер](https://github.com/stakanyash/hta_renpy/blob/main/DISCLAIMER.md)**
...
- Система HP, которое нужно восстанавливать в городе
- Система боевых лечений, которые нужно покупать в городе
- Уровни сложности, которые влияют на количество получаемого урона при боях
- Выдача рандомных предметов после боёв
- Логика чекпоинтов, которая заменяет автосейвы встроенные в Ren'Py по умолчанию

...
label dyingfather:
    ...
    father "{cps=10}Слушай внимательно. Ты мой приёмный сын. Возьми, это вещи твоего настоящего отца..."
    father "{cps=10}Найди Бена Дросселя. Он исследователь. {cps=8}Он поможет... Сын... не дай ненависти... {cps=7}отравить твою... {cps=5}душу..."
